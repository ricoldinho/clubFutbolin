...
- Tests unitarios del API: `apps/api/tests/unit/` (estructura espejo de `apps/api/src/`). Usar alias `@/` para importar desde el `src` del API (ej: `import { Player } from '@/domain/players/Player.entity'`).
